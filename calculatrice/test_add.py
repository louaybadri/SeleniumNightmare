...
class TestAdd():
  ...
  def test_add(self):
    ...
    print("Entering '63' into the num2 field and submitting")
    self.driver.find_element(By.ID, "num2").click()
    self.driver.find_element(By.ID, "num2").send_keys("63")
    self.driver.find_element(By.CSS_SELECTOR, "button").click()
    
    print("Checking the result")
    assert self.driver.find_element(By.ID, "result").text == "Résultat : 75"
